...
<!-- include Cycle plugin -->
    <script type="text/javascript" src="common/ns/js/jquery-1.7.1.min.js"></script>
...
<a href="/video.php"><img src="http://www.cordcruncher.com/imgs/1Launch.jpg" data-transition="slideInLeft" height="375" width="675"></a>
<a href="<?php echo $shop; ?>"><img src="http://www.cordcruncher.com/imgs/2Order.jpg" data-transition="slideInLeft" height="375" width="675"/></a>
<a href='<?php echo $howTo; ?>'><img src="http://www.cordcruncher.com/imgs/3Learn.jpg" data-transition="slideInLeft" height="375" width="675"/></a>
<a href="<?php echo $interact; ?>"><img src="http://www.cordcruncher.com/imgs/4Interact.jpg" data-transition="slideInLeft" height="375" width="675"/></a>            </div>
        </div>
    </div>
    <div id="news-feed">
    <!--
...
<?php //include "news.php"; ?>
         ...
         <IFRAME name="iframe" src="http://dev.cordcruncher.com/jcblog.php" width="900px" height="600px" marginwidth="0" marginheight="0" hspace="0" vspace="0" frameborder="true" scrolling="auto"></IFRAME>   
  <!-- end #mainContent --></div>
  <div id="footer">
